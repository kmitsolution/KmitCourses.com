...
<div class="container">
    ...
    <table class="course-table" style="table-layout:fixed;width:100%;">
      ...
      <tbody>
        <?php foreach ($courses as $course): ?>
          <tr>
            <td style="word-break:break-word;"><?php echo htmlspecialchars($course['exam_name']); ?></td>
            ...
            <td class="actions" style="min-width:110px;max-width:110px;gap:8px;align-items:center;">
              <a href="exam.php?delete=<?php echo urlencode($course['exam_id']); ?>" onclick="return confirm('Delete this exam?');" title="Delete" class="action-icon delete-icon"><span>🗑️</span></a>
  ...
  <script>
    function openExamEdit(course) {
      // Open addexam.php in edit mode with exam_id
      window.location.href = 'addexam.php?edit=' + encodeURIComponent(course.exam_id);
    }
